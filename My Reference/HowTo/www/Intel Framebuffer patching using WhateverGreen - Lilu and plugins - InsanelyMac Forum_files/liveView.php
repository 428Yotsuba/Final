...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo = function()
	{
		...
		{
            this.url += '&pubUrlAuto=';// + encodeURIComponent(this._getDiscoverableUrl());
		}
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=94048&cbuster=1643849462&pubUrl=https://www.insanelymac.com/forum/topic/334899-intel-framebuffer-patching-using-whatevergreen/&x=650&y=442&vp_content=plembed339lvoqmnuxt&vp_template=3057&cbuster=1552967298',
					origQString: 's=94048&cbuster=1643849462&pubUrl=https://www.insanelymac.com/forum/topic/334899-intel-framebuffer-patching-using-whatevergreen/&x=650&y=442&vp_content=plembed339lvoqmnuxt&vp_template=3057',
					x: 650,
					y: 442,
					isSlider: false,
					isOutstream: false,
					...
					inGdprRawConsent: '',
					debug: 0,
					ci: {"extra":{"schemaVer":"10","os":"Windows","osVersion":"7","osVersionMajor":"7","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"73.0.3683.75","browserVersionMajor":"73","browserVersionMinor":"0"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop"},
					geo: 'JP',
					dynamicSetup: [],
					uuid: '5c90668225bdc',
