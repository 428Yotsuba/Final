...
var SekindoClientDetections_URL = function (config) {
	...
	this._getPlayerMainElement = function(orgWin)
	{
		...
		var sourceElmt = this._getSourceElementByType(orgWin.document, this.config.playerDivSetup);
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=94048&cbuster=1127984020&pubUrl=https://www.insanelymac.com/forum/topic/334342-imac-pro-x99-live-the-future-now-with-macos-1014-mojave-successful-buildsuccessful-guide/%3Fpage%3D5%26tab%3Dcomments%23comment-2671094&x=650&y=442&vp_content=plembed339lvoqmnuxt&vp_template=3057&cbuster=1557479348',
					origQString: 's=94048&cbuster=1127984020&pubUrl=https://www.insanelymac.com/forum/topic/334342-imac-pro-x99-live-the-future-now-with-macos-1014-mojave-successful-buildsuccessful-guide/%3Fpage%3D5%26tab%3Dcomments%23comment-2671094&x=650&y=442&vp_content=plembed339lvoqmnuxt&vp_template=3057',
					x: 650,
					y: 442,
					isSlider: false,
					isOutstream: false,
					...
					float: {enabled: true,
						...
						direction: 'br', verticalOffset: 15,
						horizontalOffset: 10, isCloseBtn: 1},
					isAPI: false,
					inGdprIsRequired: 0,
					inGdprRawConsent: '',
					debug: 0,
					ci: {"extra":{"schemaVer":"10","os":"Windows","osVersion":"10","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Firefox","browserType":"browser","browserVersion":"61.0","browserVersionMajor":"61","browserVersionMinor":"0"},"browser":"firefox","os":"windows","osVer":"","deviceType":"desktop"},
					geo: 'JP',
					dynamicSetup: [],
					uuid: '5cd5318ec8606',
